...
export default function CreateBlogPage() {
  ...
  // Hàm để format ngày giờ hiện tại thành format datetime-local (YYYY-MM-DDTHH:mm)
  ...
  // Tự động load ngày giờ hiện tại khi component mount
  useEffect(() => {
    setFormData(prev => ({
      ...prev,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/proxy/admin/blog', {
        method: 'POST',
        headers: {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold glow-text mb-8">Thêm bài viết mới</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-gray-800 rounded-lg p-6 space-y-6 max-w-4xl">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">
            Mặc định là ngày giờ hiện tại. Nếu bỏ trống, hệ thống sẽ tự động lấy ngày giờ hiện tại khi tạo bài viết.
          </p>
        </div>
